...
class PushPolicy(BasePolicy_realman):
    ...
    def generate_trajectory(self, ts_first):
        ...
        self.trajectory = [
            ...
            {"t": 150, "xyz": box_xyz + np.array([-0.1, 0, -0.01]), "quat": gripper_pick_quat.elements},
            {"t": 300, "xyz": box_xyz + np.array([0.1, 0, -0.01]), "quat": gripper_pick_quat.elements},
            {"t": 400, "xyz": box_xyz + np.array([0, 0, 0.2]), "quat": gripper_pick_quat.elements},
        ]
...
def test_policy(task_name):
    ...
    if 'sim_transfer_cube' in task_name:
        ...
        env = make_ee_sim_env('sim_push_cube')
    else:
        raise NotImplementedError
    ...
    for episode_idx in range(1):
        ...
        policy = PushPolicy(inject_noise)
...
if __name__ == '__main__':
    test_task_name = 'sim_push_cube_scripted'
