...
### Task parameters
DATA_DIR = './0_data_save_dir/9.24/push_data_dir'
SIM_TASK_CONFIGS = {
    ...
    'sim_push_cube_scripted':{
        'dataset_dir': DATA_DIR,
        # 'dataset_dir': DATA_DIR + '/sim_push_cube_scripted',
        'num_episodes': 50,
        'episode_len': 400,
        'camera_names': ['top']
    },
    ...
    'sim_push_cube_human':{
        'dataset_dir': DATA_DIR + '/sim_push_cube_human',
        'num_episodes': 50,
        'episode_len': 400,
        'camera_names': ['top']
    },
...
START_ARM_POSE_REALMAN = [0, 0.73, 0, 0.7, 0, 1.68, 0]
